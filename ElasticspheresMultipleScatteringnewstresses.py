# -*- coding: utf-8 -*-
"""
Created on Wed Jun 26 13:01:33 2019
...
for N in range(Nn):
    ...
    for iterator in range(0,Nf):
        ...
        ddj1dr_KT = k_T_i*(1/(k_T_i*R_0)*dj1dr_KT - k_T_i*(2/(k_T_i*R_0)*sp.spherical_jn(2,k_T_i*R_0) - sp.spherical_jn(3,k_T_i*R_0)))
        ddj1dr_KL = k_L_i*(1/(k_L_i*R_0)*dj1dr_KL - k_L_i*(2/(k_L_i*R_0)*sp.spherical_jn(2,k_L_i*R_0) - sp.spherical_jn(3,k_L_i*R_0)))
        ddh1dr_KT = k_T_i*(1/(k_T_i*R_0)*dj1dr_KT - k_T_i*(2/(k_T_i*R_0)*spherical_hn1(2,k_T_i*R_0) - spherical_hn1(3,k_T_i*R_0)))
        ddh1dr_KL = k_L_i*(1/(k_L_i*R_0)*dj1dr_KL - k_L_i*(2/(k_L_i*R_0)*spherical_hn1(2,k_L_i*R_0) - spherical_hn1(3,k_L_i*R_0)))
        
        dddj1dr_KL = k_L_i*(1/(k_L_i*R_0)*ddj1dr_KL - k_L_i*(2/(k_L_i*R_0)*k_L_i*(2/(k_L_i*R_0)*sp.spherical_jn(2,k_L_i*R_0) - k_L_i*(3/(k_L_i*R_0)*sp.spherical_jn(3,k_L_i*R_0) - sp.spherical_jn(4,k_L_i*R_0) ))))
        dddj1dr_KT = k_T_i*(1/(k_T_i*R_0)*ddj1dr_KT - k_T_i*(2/(k_T_i*R_0)*k_T_i*(2/(k_T_i*R_0)*sp.spherical_jn(2,k_T_i*R_0) - k_T_i*(3/(k_T_i*R_0)*sp.spherical_jn(3,k_T_i*R_0) - sp.spherical_jn(4,k_T_i*R_0) ))))
        dddh1dr_KL = k_L_i*(1/(k_L_i*R_0)*ddh1dr_KL - k_L_i*(2/(k_L_i*R_0)*k_L_i*(2/(k_L_i*R_0)*spherical_hn1(2,k_L_i*R_0) - k_L_i*(3/(k_L_i*R_0)*spherical_hn1(3,k_L_i*R_0) - spherical_hn1(4,k_L_i*R_0) ))))
        dddh1dr_KT = k_T_i*(1/(k_T_i*R_0)*ddh1dr_KT - k_T_i*(2/(k_T_i*R_0)*k_T_i*(2/(k_T_i*R_0)*spherical_hn1(2,k_T_i*R_0) - k_T_i*(3/(k_T_i*R_0)*spherical_hn1(3,k_T_i*R_0) - spherical_hn1(4,k_T_i*R_0) ))))
        ...
        ddg_Ls = ddh1dr_KL + 3*S_1p*ddj1dr_KL
        ddg_Li = 3j*ddj1dr_KL
        ...
        drg_T = g_T + R_0*dh1dr_KT + 3/2*R_0*S_1s*dj1dr_KT
        ddrg_T = 2*dg_T + R_0*ddh1dr_KT + R_0*3/2*S_1s*ddj1dr_KT
        dddrg_T = 3*ddrg_T + R_0*dddh1dr_KT + R_0*3/2*S_1s*dddj1dr_KT
        ...
        SS_L = -lamda*k_L_i**2*g_Ls + 2*mhu*ddg_Ls
        SS_Li = -lamda*k_L_i**2*g_Li + 2*mhu*ddg_Li
        SS_T = 2*mhu/R_0*dddrg_T + 2*mhu*k_L_i**2/R_0*drg_T
        
        Tau_L = -2/R_0*dg_Ls + (2/R_0**2)*g_Ls
        Tau_Li = -2/R_0*dg_Li + (2/R_0**2)*g_Li
        Tau_T =  -(k_T_i**2)*g_T - 2/R_0*ddrg_T + (2/R_0**2)*drg_T
    
        DM = np.zeros((2,2), dtype = complex)
        
        DM[0,0] = 1/(rho_p*omega**2*R_0)*(-SS_L + 2*mhu*Tau_L) - dg_Ls
        DM[0,1] = 1/(rho_p*omega**2*R_0)*(-SS_T + 2*mhu*Tau_T) + 2*g_T/R_0
        DM[1,0] = -1/(rho_p*omega**2*R_0)*(-SS_L + 2*mhu*Tau_L) + g_Ls/R_0
        DM[1,1] = -1/(rho_p*omega**2*R_0)*(-SS_L + 2*mhu*Tau_L) + g_T/R_0 + dg_T
        
        
        
        P = np.zeros((2,1), dtype = complex)
        P[0,0] = -1/(rho_p*omega**2*R_0)*(-SS_L + 2*mhu*Tau_L) + dg_Li
        P[1,0] = 1/(rho_p*omega**2*R_0)*(-SS_L + 2*mhu*Tau_L)  - g_Li/R_0
